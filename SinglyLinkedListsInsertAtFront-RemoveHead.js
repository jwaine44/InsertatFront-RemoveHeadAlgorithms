...
const emptyList = new SinglyLinkedList();
  ...
  const singleNodeList = new SinglyLinkedList().insertAtFront(1).insertAtFront(2).removeHead();
  const biNodeList = new SinglyLinkedList().insertAtFront(55).insertAtFront(-2).removeHead();
